    ...
    return (
        <main className="min-h-screen bg-gray-100 text-gray-800">
            ...
            <nav className="bg-white shadow px-6 py-4 flex justify-between items-center">
                <div className="text-2xl font-bold text-blue-700">🔬 Ola Researcher</div>
                <div className="space-x-4">
                    <AuthButton />
                    <Link href="/faculty"><button className="text-blue-700 hover:underline">Faculty List</button></Link>
                    <Link href="/upload"><button className="bg-blue-700 text-white px-4 py-2 rounded hover:bg-blue-800">Upload CV</button></Link>
                </div>
            </nav>
